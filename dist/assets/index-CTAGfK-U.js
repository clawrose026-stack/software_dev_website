...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Ra(e,t,n){let r=new Float32Array(wa),i=new W(0,1,0);return new vi({name:`SphericalGaussianBlur`,defines:{n:wa,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Va(),fragmentShader:`
	...
	`}var Ha=class extends Ht{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new ii(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)}var ps={1:`Linear`,2:`Reinhard`,3:`Cineon`,4:`ACESFilmic`,6:`AgX`,7:`Neutral`,5:`Custom`};function ms(e,t){let n=ps[t];return n===void 0?(V(`WebGLProgram: Unsupported toneMapping:`,t),`vec3 `+e+`( vec3 color ) { return LinearToneMapping( color ); }`):`vec3 `+e+`( vec3 color ) { return `+n+`ToneMapping( color ); }`}var hs=new W;function gs(){return K.getLuminanceCoefficients(hs),[`float luminance( const in vec3 rgb ) {`,`	const vec3 weights = vec3( ${hs.x.toFixed(4)}, ${hs.y.toFixed(4)}, ${hs.z.toFixed(4)} );`,`	return dot( weights, rgb );`,`}`].join(`
...
void main() {
    ...
    `,transparent:!0}),l=new Kr(new li(2,2),c);a.add(l);let u=()=>{let e=r.getBoundingClientRect();i.setSize(e.width,e.height),s.uResolution.value.set(e.width,e.height)};u(),window.addEventListener(`resize`,u);let d={x:.5,y:.5},f={x:.5,y:.5},p=e=>{let t=r.getBoundingClientRect();d.x=(e.clientX-t.left)/t.width,d.y=1-(e.clientY-t.top)/t.height},m=()=>{d.x=.5,d.y=.5},h=e=>{let t=e.touches[0],n=r.getBoundingClientRect();d.x=(t.clientX-n.left)/n.width,d.y=1-(t.clientY-n.top)/n.height},g=()=>{d.x=.5,d.y=.5};r.addEventListener(`mousemove`,p),r.addEventListener(`mouseleave`,m),r.addEventListener(`touchmove`,h,{passive:!0}),r.addEventListener(`touchend`,g);let _=new ca,v,y=()=>{v=requestAnimationFrame(y),f.x+=(d.x-f.x)*.04,f.y+=(d.y-f.y)*.04,s.uMouse.value.set(f.x,f.y),s.uTime.value=_.getElapsedTime(),i.render(a,o)};y();let b=new IntersectionObserver(e=>{e.forEach(e=>{e.isIntersecting?_.start():_.stop()})},{threshold:.05});return b.observe(r),()=>{window.removeEventListener(`resize`,u),r.removeEventListener(`mousemove`,p),r.removeEventListener(`mouseleave`,m),r.removeEventListener(`touchmove`,h),r.removeEventListener(`touchend`,g),b.disconnect(),cancelAnimationFrame(v),i.dispose()}},[]),(0,f.jsxs)(`section`,{className:`hero`,ref:t,children:[(0,f.jsx)(`canvas`,{className:`hero__canvas`,ref:e}),(0,f.jsxs)(`div`,{className:`hero__content`,children:[(0,f.jsxs)(`p`,{className:`hero__subheading`,children:[`FUTURE-FOCUSED SOFTWARE DEVELOPMENT`,(0,f.jsx)(`br`,{}),`& DATA-DRIVEN DIGITAL MARKETING`]}),(0,f.jsxs)(`h1`,{className:`hero__title`,children:[`Full Service Digital`,(0,f.jsx)(`br`,{}),`Solutions Company to`,(0,f.jsx)(`br`,{}),`Help Your Business Scale`]}),(0,f.jsx)(`p`,{className:`hero__description`,children:`Grow your business with smarter systems, a stronger online presence, and better leads. At FUSEBOX ONLINE, we combine innovation and strategy to deliver scalable software and ROI-focused marketing for lasting success.`}),(0,f.jsx)(`a`,{href:`#quote`,className:`hero__btn`,onClick:e=>{e.preventDefault(),document.getElementById(`quote`)?.scrollIntoView({behavior:`smooth`})},children:`BOOK YOUR DISCOVERY CALL`})]}),(0,f.jsxs)(`div`,{className:`hero__live-btn`,children:[(0,f.jsx)(`span`,{className:`live-dot`}),` GO LIVE`]})]})}function Oc(){return(0,f.jsx)(`section`,{className:`about`,id:`about`,children:(0,f.jsxs)(`div`,{className:`about__wrapper`,children:[(0,f.jsx)(`p`,{className:`section-label reveal`,children:`About us`}),(0,f.jsx)(`p`,{className:`about__text reveal reveal-delay-1`,children:`We're a premium software development agency, crafting high-performance websites, web applications, and digital experiences that transform brands and drive measurable business growth.`})]})})}var kc=[{number:`01`,title:`Custom Websites`,desc:`Pixel-perfect, responsive websites built from scratch. From corporate sites to creative portfolios, we design experiences that captivate visitors and convert them into customers.`,icon:(0,f.jsxs)(`svg`,{viewBox:`0 0 24 24`,"stroke-linecap":`round`,"stroke-linejoin":`round`,children:[(0,f.jsx)(`rect`,{x:`2`,y:`3`,width:`20`,height:`14`,rx:`2`,ry:`2`}),(0,f.jsx)(`line`,{x1:`8`,y1:`21`,x2:`16`,y2:`21`}),(0,f.jsx)(`line`,{x1:`12`,y1:`17`,x2:`12`,y2:`21`})]})},{number:`02`,title:`Web Applications`,desc:`Full-stack web applications with modern frameworks like React, Next.js, and Node.js. Scalable architectures, real-time features, and seamless user experiences.`,icon:(0,f.jsxs)(`svg`,{viewBox:`0 0 24 24`,"stroke-linecap":`round`,"stroke-linejoin":`round`,children:[(0,f.jsx)(`polyline`,{points:`16 18 22 12 16 6`}),(0,f.jsx)(`polyline`,{points:`8 6 2 12 8 18`}),(0,f.jsx)(`line`,{x1:`14`,y1:`4`,x2:`10`,y2:`20`})]})},{number:`03`,title:`E-Commerce`,desc:`High-converting online stores with integrated payment gateways, inventory management, and analytics. Built to scale from startup to enterprise-level traffic.`,icon:(0,f.jsxs)(`svg`,{viewBox:`0 0 24 24`,"stroke-linecap":`round`,"stroke-linejoin":`round`,children:[(0,f.jsx)(`rect`,{x:`5`,y:`2`,width:`14`,height:`20`,rx:`2`,ry:`2`}),(0,f.jsx)(`line`,{x1:`12`,y1:`18`,x2:`12.01`,y2:`18`})]})},{number:`04`,title:`UI/UX Design`,desc:`Research-driven interface design with interactive prototyping, user testing, and design systems. We create intuitive experiences that users love and remember.`,icon:(0,f.jsxs)(`svg`,{viewBox:`0 0 24 24`,"stroke-linecap":`round`,"stroke-linejoin":`round`,children:[(0,f.jsx)(`path`,{d:`M12 20h9`}),(0,f.jsx)(`path`,{d:`M16.5 3.5a2.121 2.121 0 013 3L7 19l-4 1 1-4L16.5 3.5z`})]})}];function Ac(){return(0,f.jsx)(`section`,{className:`services`,id:`services`,children:(0,f.jsxs)(`div`,{className:`services__wrapper`,children:[(0,f.jsx)(`p`,{className:`section-label reveal`,children:`What we build`}),(0,f.jsx)(`h2`,{className:`services__heading reveal reveal-delay-1`,children:`End-to-End Web Solutions`}),(0,f.jsx)(`div`,{className:`services__grid`,children:kc.map((e,t)=>(0,f.jsxs)(`div`,{className:`service-card reveal reveal-delay-${t+1}`,children:[(0,f.jsx)(`div`,{className:`service-card__icon`,children:e.icon}),(0,f.jsx)(`span`,{className:`service-card__number`,children:e.number}),(0,f.jsx)(`h3`,{className:`service-card__title`,children:e.title}),(0,f.jsx)(`p`,{className:`service-card__desc`,children:e.desc})]},e.number))})]})})}var jc=[{title:`Pixel-Perfect Quality`,desc:`Every detail matters. We obsess over typography, spacing, and interactions to deliver websites that feel polished and premium at every screen size.`,icon:(0,f.jsxs)(`svg`,{viewBox:`0 0 24 24`,"stroke-linecap":`round`,"stroke-linejoin":`round`,children:[(0,f.jsx)(`path`,{d:`M22 11.08V12a10 10 0 11-5.93-9.14`}),(0,f.jsx)(`polyline`,{points:`22 4 12 14.01 9 11.01`})]})},{title:`Senior Developers Only`,desc:`Your project is handled by experienced engineers and designers with 8+ years average experience, not juniors or outsourced freelancers.`,icon:(0,f.jsxs)(`svg`,{viewBox:`0 0 24 24`,"stroke-linecap":`round`,"stroke-linejoin":`round`,children:[(0,f.jsx)(`path`,{d:`M17 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2`}),(0,f.jsx)(`circle`,{cx:`9`,cy:`7`,r:`4`}),(0,f.jsx)(`path`,{d:`M23 21v-2a4 4 0 00-3-3.87`}),(0,f.jsx)(`path`,{d:`M16 3.13a4 4 0 010 7.75`})]})},{title:`On-Time Delivery`,desc:`98% on-time delivery rate. We set realistic timelines, provide weekly progress updates, and never compromise on deadlines or quality.`,icon:(0,f.jsxs)(`svg`,{viewBox:`0 0 24 24`,"stroke-linecap":`round`,"stroke-linejoin":`round`,children:[(0,f.jsx)(`circle`,{cx:`12`,cy:`12`,r:`10`}),(0,f.jsx)(`polyline`,{points:`12 6 12 12 16 14`})]})},{title:`SEO & Performance`,desc:`Every site ships with 90+ Lighthouse scores, structured data, and SEO best practices baked in from day one — not bolted on after.`,icon:(0,f.jsxs)(`svg`,{viewBox:`0 0 24 24`,"stroke-linecap":`round`,"stroke-linejoin":`round`,children:[(0,f.jsx)(`polyline`,{points:`23 6 13.5 15.5 8.5 10.5 1 18`}),(0,f.jsx)(`polyline`,{points:`17 6 23 6 23 12`})]})},{title:`Rock-Solid Security`,desc:`SSL certificates, OWASP-compliant code, automated vulnerability scanning, and regular security audits to keep your site and users safe.`,icon:(0,f.jsx)(`svg`,{viewBox:`0 0 24 24`,"stroke-linecap":`round`,"stroke-linejoin":`round`,children:(0,f.jsx)(`path`,{d:`M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z`})})},{title:`Ongoing Support`,desc:`Launch is just the beginning. We offer maintenance plans, performance monitoring, and feature updates to keep your site ahead of the curve.`,icon:(0,f.jsx)(`svg`,{viewBox:`0 0 24 24`,"stroke-linecap":`round`,"stroke-linejoin":`round`,children:(0,f.jsx)(`path`,{d:`M21 15a2 2 0 01-2 2H7l-4 4V5a2 2 0 012-2h14a2 2 0 012 2z`})})}];function Mc(){return(0,f.jsx)(`section`,{className:`benefits`,id:`benefits`,children:(0,f.jsxs)(`div`,{className:`benefits__wrapper`,children:[(0,f.jsx)(`p`,{className:`section-label reveal`,children:`Why choose us`}),(0,f.jsx)(`h2`,{className:`benefits__heading reveal reveal-delay-1`,children:`Built for Digital Excellence`}),(0,f.jsx)(`p`,{className:`benefits__sub reveal reveal-delay-2`,children:`We combine cutting-edge technology with creative design to deliver websites that outperform the competition and exceed expectations.`}),(0,f.jsx)(`div`,{className:`benefits__grid`,children:jc.map((e,t)=>(0,f.jsxs)(`div`,{className:`benefit-item reveal reveal-delay-${t%4+1}`,children:[(0,f.jsx)(`div`,{className:`benefit-item__icon`,children:e.icon}),(0,f.jsxs)(`div`,{className:`benefit-item__content`,children:[(0,f.jsx)(`h3`,{children:e.title}),(0,f.jsx)(`p`,{children:e.desc})]})]},e.title))})]})})}var Nc=[{number:`01`,title:`Discovery & Strategy`,desc:`We deep-dive into your brand, audience, and goals to define the project scope, tech stack, sitemap, and a detailed roadmap.`},{number:`02`,title:`Design & Prototype`,desc:`Our designers craft wireframes and high-fidelity mockups in Figma, iterating with you until every screen is approved and pixel-perfect.`},{number:`03`,title:`Development & QA`,desc:`Clean, performant code built with modern frameworks. Rigorous cross-browser testing, accessibility checks, and performance optimization at every sprint.`},{number:`04`,title:`Launch & Scale`,desc:`Deployment to production with CI/CD pipelines, analytics setup, SEO submission, and ongoing monitoring to ensure a flawless launch and sustainable growth.`}];function Pc(){return(0,f.jsx)(`section`,{className:`process`,id:`process`,children:(0,f.jsxs)(`div`,{className:`process__wrapper`,children:[(0,f.jsx)(`p`,{className:`section-label reveal`,children:`Our process`}),(0,f.jsx)(`h2`,{className:`process__heading reveal reveal-delay-1`,children:`From Brief to Launch in Four Phases`}),(0,f.jsx)(`div`,{className:`process__steps`,children:Nc.map((e,t)=>(0,f.jsxs)(`div`,{className:`process-step reveal reveal-delay-${t+1}`,children:[(0,f.jsx)(`div`,{className:`process-step__number`,children:e.number}),(0,f.jsx)(`h3`,{className:`process-step__title`,children:e.title}),(0,f.jsx)(`p`,{className:`process-step__desc`,children:e.desc})]},e.number))})]})})}var Fc=[{target:200,suffix:`+`,label:`Websites Launched`},{target:98,suffix:`%`,label:`Client Satisfaction`},{target:12,suffix:`+`,label:`Years Experience`},{target:35,suffix:`+`,label:`Team Members`}];function Ic({target:e,suffix:t,label:n,delay:r}){let[i,a]=(0,l.useState)(0),[o,s]=(0,l.useState)(!1),c=(0,l.useRef)(null);return(0,l.useEffect)(()=>{let e=new IntersectionObserver(([t])=>{t.isIntersecting&&(s(!0),e.disconnect())},{threshold:.3});return c.current&&e.observe(c.current),()=>e.disconnect()},[]),(0,l.useEffect)(()=>{if(!o)return;let t=0,n=e/60,r=setInterval(()=>{t+=n,t>=e&&(t=e,clearInterval(r)),a(Math.floor(t))},25);return()=>clearInterval(r)},[o,e]),(0,f.jsxs)(`div`,{className:`stat-item reveal reveal-delay-${r}`,ref:c,children:[(0,f.jsxs)(`div`,{className:`stat-item__number`,children:[i,(0,f.jsx)(`span`,{children:t})]}),(0,f.jsx)(`div`,{className:`stat-item__label`,children:n})]})}function Lc(){return(0,f.jsx)(`section`,{className:`stats`,children:(0,f.jsx)(`div`,{className:`stats__wrapper`,children:Fc.map((e,t)=>(0,f.jsx)(Ic,{...e,delay:t+1},e.label))})})}function Rc(){let[e,t]=(0,l.useState)({name:``,email:``,project:``,budget:``,description:``}),[n,r]=(0,l.useState)(!1),[i,a]=(0,l.useState)(!1),o=n=>{t({...e,[n.target.name]:n.target.value})};return(0,f.jsxs)(`section`,{className:`cta`,id:`quote`,children:[(0,f.jsx)(`div`,{className:`cta__blob`}),(0,f.jsxs)(`div`,{className:`cta__wrapper`,children:[(0,f.jsxs)(`div`,{className:`cta__header`,children:[(0,f.jsx)(`p`,{className:`section-label reveal`,style:{display:`inline-block`},children:`Get started`}),(0,f.jsx)(`h2`,{className:`cta__heading reveal reveal-delay-1`,children:`Request a Free Quote`}),(0,f.jsx)(`p`,{className:`cta__sub reveal reveal-delay-2`,children:`Tell us about your project and we'll get back to you within 24 hours with a tailored proposal and timeline.`})]}),(0,f.jsx)(`div`,{className:`quote-form reveal reveal-delay-3`,id:`quote-form-container`,children:n?(0,f.jsxs)(`div`,{className:`quote-form__success show`,children:[(0,f.jsxs)(`svg`,{viewBox:`0 0 24 24`,"stroke-linecap":`round`,"stroke-linejoin":`round`,children:[(0,f.jsx)(`path`,{d:`M22 11.08V12a10 10 0 11-5.93-9.14`}),(0,f.jsx)(`polyline`,{points:`22 4 12 14.01 9 11.01`})]}),(0,f.jsx)(`h3`,{children:`Quote Request Sent!`}),(0,f.jsx)(`p`,{children:`Thank you for reaching out. Our team will review your project details and get back to you within 24 hours with a tailored proposal.`})]}):(0,f.jsxs)(`form`,{id:`quote-form`,onSubmit:e=>{e.preventDefault(),a(!0),setTimeout(()=>{r(!0),a(!1)},1200)},children:[(0,f.jsxs)(`div`,{className:`quote-form__grid`,children:[(0,f.jsxs)(`div`,{className:`quote-form__group`,children:[(0,f.jsx)(`label`,{className:`quote-form__label`,htmlFor:`form-name`,children:`Full Name`}),(0,f.jsx)(`input`,{className:`quote-form__input`,type:`text`,id:`form-name`,name:`name`,placeholder:`John Smith`,value:e.name,onChange:o,required:!0})]}),(0,f.jsxs)(`div`,{className:`quote-form__group`,children:[(0,f.jsx)(`label`,{className:`quote-form__label`,htmlFor:`form-email`,children:`Email Address`}),(0,f.jsx)(`input`,{className:`quote-form__input`,type:`email`,id:`form-email`,name:`email`,placeholder:`john@company.com`,value:e.email,onChange:o,required:!0})]}),(0,f.jsxs)(`div`,{className:`quote-form__group`,children:[(0,f.jsx)(`label`,{className:`quote-form__label`,htmlFor:`form-project`,children:`Project Type`}),(0,f.jsxs)(`select`,{className:`quote-form__select`,id:`form-project`,name:`project`,value:e.project,onChange:o,required:!0,children:[(0,f.jsx)(`option`,{value:``,disabled:!0,children:`Select a project type`}),(0,f.jsx)(`option`,{value:`corporate`,children:`Corporate Website`}),(0,f.jsx)(`option`,{value:`ecommerce`,children:`E-Commerce Store`}),(0,f.jsx)(`option`,{value:`webapp`,children:`Web Application`}),(0,f.jsx)(`option`,{value:`landing`,children:`Landing Page`}),(0,f.jsx)(`option`,{value:`redesign`,children:`Website Redesign`}),(0,f.jsx)(`option`,{value:`other`,children:`Other`})]})]}),(0,f.jsxs)(`div`,{className:`quote-form__group`,children:[(0,f.jsx)(`label`,{className:`quote-form__label`,htmlFor:`form-budget`,children:`Estimated Budget`}),(0,f.jsxs)(`select`,{className:`quote-form__select`,id:`form-budget`,name:`budget`,value:e.budget,onChange:o,required:!0,children:[(0,f.jsx)(`option`,{value:``,disabled:!0,children:`Select your budget range`}),(0,f.jsx)(`option`,{value:`5k-10k`,children:`$5,000 — $10,000`}),(0,f.jsx)(`option`,{value:`10k-25k`,children:`$10,000 — $25,000`}),(0,f.jsx)(`option`,{value:`25k-50k`,children:`$25,000 — $50,000`}),(0,f.jsx)(`option`,{value:`50k-100k`,children:`$50,000 — $100,000`}),(0,f.jsx)(`option`,{value:`100k+`,children:`$100,000+`})]})]}),(0,f.jsxs)(`div`,{className:`quote-form__group full-width`,children:[(0,f.jsx)(`label`,{className:`quote-form__label`,htmlFor:`form-description`,children:`Project Description`}),(0,f.jsx)(`textarea`,{className:`quote-form__textarea`,id:`form-description`,name:`description`,placeholder:`Tell us about your project — goals, features, timeline, and any inspiration sites...`,value:e.description,onChange:o,required:!0})]})]}),(0,f.jsx)(`button`,{type:`submit`,className:`quote-form__submit`,id:`form-submit-btn`,disabled:i,style:{opacity:i?`0.6`:`1`},children:i?`Sending...`:`Send Quote Request`})]})})]})]})}function zc(){return(0,f.jsx)(`footer`,{className:`footer`,children:(0,f.jsxs)(`div`,{className:`footer__wrapper`,children:[(0,f.jsxs)(`div`,{className:`footer__top`,children:[(0,f.jsxs)(`div`,{className:`footer__brand`,children:[(0,f.jsxs)(`div`,{className:`footer__logo`,children:[`Coinsetters`,(0,f.jsx)(`sup`,{style:{fontSize:`0.5em`},children:`®`})]}),(0,f.jsx)(`p`,{className:`footer__brand-desc`,children:`Premium software development agency crafting stunning websites and digital experiences since 2014.`})]}),(0,f.jsxs)(`div`,{className:`footer__links`,children:[(0,f.jsxs)(`div`,{className:`footer__col`,children:[(0,f.jsx)(`h4`,{children:`Company`}),(0,f.jsxs)(`ul`,{children:[(0,f.jsx)(`li`,{children:(0,f.jsx)(`a`,{href:`#about`,children:`About Us`})}),(0,f.jsx)(`li`,{children:(0,f.jsx)(`a`,{href:`#services`,children:`Services`})}),(0,f.jsx)(`li`,{children:(0,f.jsx)(`a`,{href:`#benefits`,children:`Why Us`})}),(0,f.jsx)(`li`,{children:(0,f.jsx)(`a`,{href:`#process`,children:`Process`})})]})]}),(0,f.jsxs)(`div`,{className:`footer__col`,children:[(0,f.jsx)(`h4`,{children:`Services`}),(0,f.jsxs)(`ul`,{children:[(0,f.jsx)(`li`,{children:(0,f.jsx)(`a`,{href:`#services`,children:`Custom Websites`})}),(0,f.jsx)(`li`,{children:(0,f.jsx)(`a`,{href:`#services`,children:`Web Applications`})}),(0,f.jsx)(`li`,{children:(0,f.jsx)(`a`,{href:`#services`,children:`E-Commerce`})}),(0,f.jsx)(`li`,{children:(0,f.jsx)(`a`,{href:`#services`,children:`UI/UX Design`})})]})]}),(0,f.jsxs)(`div`,{className:`footer__col`,children:[(0,f.jsx)(`h4`,{children:`Connect`}),(0,f.jsxs)(`ul`,{children:[(0,f.jsx)(`li`,{children:(0,f.jsx)(`a`,{href:`#quote`,children:`Get a Quote`})}),(0,f.jsx)(`li`,{children:(0,f.jsx)(`a`,{href:`#`,children:`Twitter / X`})}),(0,f.jsx)(`li`,{children:(0,f.jsx)(`a`,{href:`#`,children:`LinkedIn`})}),(0,f.jsx)(`li`,{children:(0,f.jsx)(`a`,{href:`#`,children:`Dribbble`})})]})]})]})]}),(0,f.jsxs)(`div`,{className:`footer__bottom`,children:[(0,f.jsx)(`span`,{className:`footer__copy`,children:`© 2026 Coinsetters®. All rights reserved.`}),(0,f.jsxs)(`div`,{className:`footer__socials`,children:[(0,f.jsx)(`a`,{href:`#`,"aria-label":`Twitter`,children:(0,f.jsx)(`svg`,{viewBox:`0 0 24 24`,children:(0,f.jsx)(`path`,{d:`M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z`})})}),(0,f.jsx)(`a`,{href:`#`,"aria-label":`LinkedIn`,children:(0,f.jsx)(`svg`,{viewBox:`0 0 24 24`,children:(0,f.jsx)(`path`,{d:`M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433a2.062 2.062 0 01-2.063-2.065 2.064 2.064 0 112.063 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z`})})}),(0,f.jsx)(`a`,{href:`#`,"aria-label":`Dribbble`,children:(0,f.jsx)(`svg`,{viewBox:`0 0 24 24`,children:(0,f.jsx)(`path`,{d:`M12 0C5.375 0 0 5.375 0 12s5.375 12 12 12 12-5.375 12-12S18.625 0 12 0zm7.938 5.563a10.18 10.18 0 012.312 6.375c-.337-.063-3.712-.75-7.125-.325-.062-.15-.125-.313-.2-.475-.2-.463-.413-.925-.637-1.375 3.8-1.55 5.525-3.775 5.65-3.95v-.25zM12 1.75c2.625 0 5.025 1.013 6.825 2.663-.1.15-1.663 2.25-5.35 3.625A88.608 88.608 0 009.5 1.963 10.303 10.303 0 0112 1.75zM7.625 2.638a104.387 104.387 0 013.95 6.05c-4.975 1.325-9.362 1.3-9.837 1.3A10.294 10.294 0 017.625 2.638zM1.75 12.013v-.338c.463.013 5.588.063 10.875-1.513.3.588.588 1.2.85 1.8l-.4.113c-5.563 1.8-8.525 6.688-8.675 6.938A10.19 10.19 0 011.75 12.013zm3.975 8.35c.1-.163 2.325-4.388 8.275-6.45.025-.013.038-.013.063-.025a65.37 65.37 0 012.262 8.05 10.236 10.236 0 01-10.6-1.575zm12.35.675a68.157 68.157 0 00-2.1-7.6c3.213-.513 6.025.325 6.387.438a10.236 10.236 0 01-4.287 7.162z`})})})]})]})]})})}function Bc(){return(0,l.useEffect)(()=>{let e=new IntersectionObserver(t=>{t.forEach(t=>{t.isIntersecting&&(t.target.classList.add(`visible`),e.unobserve(t.target))})},{threshold:.12,rootMargin:`0px 0px -40px 0px`});return document.querySelectorAll(`.reveal`).forEach(t=>e.observe(t)),()=>e.disconnect()},[]),(0,f.jsxs)(f.Fragment,{children:[(0,f.jsx)(p,{}),(0,f.jsx)(Dc,{}),(0,f.jsx)(Oc,{}),(0,f.jsx)(Ac,{}),(0,f.jsx)(Mc,{}),(0,f.jsx)(Pc,{}),(0,f.jsx)(Lc,{}),(0,f.jsx)(Rc,{}),(0,f.jsx)(zc,{})]})}(0,u.createRoot)(document.getElementById(`root`)).render((0,f.jsx)(l.StrictMode,{children:(0,f.jsx)(Bc,{})}));